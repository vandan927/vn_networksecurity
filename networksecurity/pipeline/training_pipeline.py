...
class TrainingPipeline:
    ...
    def start_data_transformation(self,data_validation_artifact: DataValidationArtifact):
        try:
            ...
            logging.info("Inititaed Data Transformation")
    ...
    #pushing local artifact to s3 bucket
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer_artifact=model_trainer_artifact=self.start_model_trainer(data_transformation_artifact=data_transformation_artifact)
